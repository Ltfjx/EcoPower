...
public class EcoPowerPlugin extends JavaPlugin implements SlimefunAddon {
    ...
    public void onEnable() {
        ...
        ItemStack categoryItem = new CustomItem(SlimefunUtils.getCustomHead("240775c3ad75763613f32f04986881bbe4eee4366d0c57f17f7c7514e2d0a77d"), "&2EcoPower(绿色能源发电)");
        Category category = new Category(new NamespacedKey(this, "generators"), categoryItem, 4);

        SlimefunItemStack rotor = new SlimefunItemStack("STEEL_ROTOR", "c51944b488e11cda65177d5911d651282b3012665e63b8929e1b6a4744b7ca8", "&b钢轮子");
        ...
        SteamTurbine simpleTurbine = registerSteamTurbine(category, "STEAM_TURBINE", "aefd921cb61594324f3c09d7ac7d38185d2734333968f3ac38382cddf15f6d71", "&e简易蒸气发电机", MachineTier.MEDIUM, 4, new ItemStack[] {
                null, rotor, null,
                SlimefunItems.STEEL_INGOT, SlimefunItems.ELECTRIC_MOTOR, SlimefunItems.STEEL_INGOT,
                null, SlimefunItems.COPPER_WIRE, null
        });
        
        SteamTurbine advancedTurbine = registerSteamTurbine(category, "STEAM_TURBINE_2", "161aad79fb748bff1e6e94d4b6a5a277cc961c1a9abfe2a4ed88baab8a2b5971", "&c进阶蒸气发电机", MachineTier.ADVANCED, 6, new ItemStack[] {
                null, rotor, null,
        ...
        registerSteamTurbine(category, "STEAM_TURBINE_3", "b65e29a67860d82f66afe1060ec8a9ceacc8c7afe108f5d42f52ba854b0a62dc", "&4黑钻石蒸气发电机", MachineTier.END_GAME, 13, new ItemStack[] {
                null, rotor, null,
        ...
        WindTurbine advancedWindTurbine = registerWindTurbine(category, "WIND_TURBINE_2", "2df9e595dbeac33f43b37dd4ffbc234ea0fa7c3f98aad77dc906ce5d6783c79d", "&c进阶风力发电机", MachineTier.ADVANCED, 11, new ItemStack[] {
                null, rotor, null,
        ...
        registerWindTurbine(category, "WIND_TURBINE_3", "3fcef461b43f06ef9d58c94065bbf41b77a10050520b44082d5f66f6dbe71da0", "&4黑钻石风力发电机", MachineTier.END_GAME, 23, new ItemStack[] {
        ...
        registerLightningReceptor(category, "LIGHTNING_RECEPTOR", "&e闪电接收器", 512, 8192, new ItemStack[] {
        ...
        SolarGenerator solarGenerator = registerHighEnergySolarGenerator(category, "HIGH_ENERGY_SOLAR_GENERATOR", "c4fe135c311f7086edcc5e6dbc4ef4b23f819fddaa42f827dac46e3574de2287", "&9万能太阳能发电机", 256, new ItemStack[] {
        ...
        registerSolarHelmet(category, "HIGH_ENERGY_SOLAR_HELMET", "&9万能太阳能头盔", 5, new ItemStack[] {
    ...
    private LightningReceptor registerLightningReceptor(Category category, String id, String name, int min, int max, ItemStack[] recipe) {
        ...
        SlimefunItemStack item = new SlimefunItemStack(id, texture, name, "", "&f此机器可在雷雨天气时", "&f从雷击中发电", "", "", LoreBuilder.machine(MachineTier.END_GAME, MachineType.GENERATOR), LoreBuilder.power(min, " - " + max + " J 次雷击"));
    ...
    private LunarGenerator registerLunarGenerator(Category category, String id, String name, int power, ItemStack[] recipe) {
        ...
        SlimefunItemStack item = new SlimefunItemStack(id, texture, name, "", "&f月光发电机", "&f只会在晚上运作!", "", LoreBuilder.machine(MachineTier.END_GAME, MachineType.GENERATOR), LoreBuilder.powerBuffer(0), LoreBuilder.powerPerSecond(power * 2));
    ...
    private HighEnergySolarGenerator registerHighEnergySolarGenerator(Category category, String id, String texture, String name, int power, ItemStack[] recipe) {
        SlimefunItemStack item = new SlimefunItemStack(id, texture, name, "", "&f此太阳能发电机", "&f可在任何时间发电!", "", LoreBuilder.machine(MachineTier.END_GAME, MachineType.GENERATOR), LoreBuilder.powerBuffer(0), LoreBuilder.powerPerSecond(power * 2));
    ...
    private SolarHelmet registerSolarHelmet(Category category, String id, String name, int power, ItemStack[] recipe) {
        SlimefunItemStack item = new SlimefunItemStack(id, Material.IRON_HELMET, name, "", "&f此太阳能头盔可充", "&f身上的装备和手持的物品", "", LoreBuilder.power(power, "/次充电"));
    ...
    public String getBugTrackerURL() {
        return "https://github.com/Ltfjx/EcoPower/issues";
    }
